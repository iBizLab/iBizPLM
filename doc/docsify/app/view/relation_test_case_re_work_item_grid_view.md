# 关联(relation_test_case_re_work_item_grid_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面逻辑
  * [工作项(WORK_ITEM)](module/ProjMgmt/work_item) : [用例关联工作项](module/ProjMgmt/work_item/uilogic/test_case_relation_work_item)
